...
public class Stream2 {
    ...
    public static void main(String args[])
   {
       ...
       //3rd example no starting with 2
     List<Integer>integers=  integerList1.stream().map(e->e.toString()).filter(e->e.startsWith("2")).map(Integer:: valueOf).collect(Collectors.toList());
